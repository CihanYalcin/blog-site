...
app.post("/compose", function (req, res) {
    const compose = {
        ...
        content:_.capitalize(req.body.post)
    };
    posts.push(compose);
...
app.get("/posts/:postName", function(req,res){
    ...
    if (storedTitle===requestedTitle){
        const title=_.capitalize(storedTitle);
        res.render("post",{storedPost:storedPost, storedTitle:title} );
